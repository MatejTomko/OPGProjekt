        ...
        new Thread(() -> {
            try {
                while(true) {
                    ...
                    List<Client> entry = ServerController.clients;
                ...
                try {
                    dis.close();
                    dos.close();
                    ServerController.clients = ServerController.clients.stream()
                            .filter(e -> {
                                if(!(e == this)) {
                    ...
                    System.out.println("[Current User : " + ServerController.clients.size() + "]");
